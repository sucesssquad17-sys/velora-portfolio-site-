...
export const BenefitsSection = () => {
  return (
    <section className="bg-white py-16 md:py-20 border-b border-stone-100">
          ...
          {benefits.map((benefit, idx) => {
            ...
            return (
              <div key={idx} className="flex flex-col items-start text-left">
                <div className="h-10 w-10 flex items-center justify-center bg-stone-50 rounded-full text-stone-800 mb-4">
